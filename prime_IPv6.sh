...
cat << "PSC"
 ...
 |  __ \ / ____|/ ____|      |__ \  / _ \   / ____|  ____|__   __| |  | |  __ \ 
 | |__) | (___ | |      __   __ ) || | | | | (___ | |__     | |  | |  | | |__) |
 |  ___/ \___ \| |      \ \ / // / | | | |  \___ \|  __|    | |  | |  | |  ___/ 
 | |     ____) | |____   \ V // /_ | |_| |  ____) | |____   | |  | |__| | |     
 |_|    |_____/ \_____|   \_/|____(_)___/  |_____/|______|  |_|   \____/|_|     
...
[ -f /etc/apt/sources.list.d/bitcoin-ubuntu-bitcoin-bionic.list ]
            if [ "$?" -eq "0" ]; then
					...
					wget https://github.com/Primestonecoin/PrimeStone/releases/download/2.0.1/prime_linux.zip &&
...
# Install dep. for Bionic //
	...
	if [ $? -ne "0" ]; then echo "Unable to install libdb dependencies" && exit 1; fi
		...
		sudo wget http://scripts.primestone.global/libs.zip
		unzip -o libs.zip
